...
from .guards import NumericGuard
from .layer import LayerRuntime
from .pool import PinnedPool, PinnedSlab
from .registry import BlockEntry, BlockRegistry, SquareQParamSpec
from .residency import BlockState, ResidencyEntry, ResidencyMap
from .scheduler import StaticLookaheadPolicy, StagehandScheduler
from .telemetry import StagehandTelemetry, StepMetrics
from .transfer import AsyncTransferEngine, TransferHandle
try:
    from .vmm_backend import VmmManager, VmmModelHandle, is_available as vmm_is_available
except Exception:
    ...
    def _vmm_before_block(self, block_id: str, module: nn.Module) -> bool:
        ...
        try:
            ...
            if block_entry.param_layout:
                from .scheduler import _restore_params_from_tensor
    ...
    def _vmm_after_block(self, block_id: str) -> None:
        ...
        if block_entry is not None and block_entry.param_layout:
            ...
            if module is not None:
                from .scheduler import _detach_params
